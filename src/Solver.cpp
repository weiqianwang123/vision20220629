...
bool Solver::solve(const std::vector<cv::Point2f> &_points_2D ,const BoxSize &_box_size){
    ...
    cv::solvePnP(points_3D,points_2D,param.camera_matrix,param.dist_coeffs,rVec,tVec,false,cv::SOLVEPNP_IPPE);
...
SolverParam::SolverParam()
{
    ...
    cv::FileStorage fs("../configure/setting.xml", cv::FileStorage::READ);
